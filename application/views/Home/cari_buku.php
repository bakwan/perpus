 <div class="col-xl-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <?php $no=0; foreach($hasil as $row): $jenis=$row->jenis==1?'hardcopy':'softcopy'; $no++;?>
                            <tr>
                                <td><?php echo $no;?></td>
                                ...
                                <td><a target="_blank" href="<?php echo base_url()."assets/images/".$row->file; ?>" ><?php echo $row->file;?></a></td>
                            </tr>
                            <?php endforeach;?>
                        </table>
    </div>                 